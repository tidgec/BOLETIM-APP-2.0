...
export function SearchDisableHistory() {
      ...
      <section className="mx-auto w-full max-w-[90rem]">
        ...
        <form className="my-8 flex flex-col items-center justify-center gap-6">
          <h3 className="text-2xl font-bold">
            Pesquisar pelo aluno que deseja desativar o histórico
          </h3>
          ...
          <div className="space-x items-center">
            ...
            <select
              id="filter_search_disable_history"
              value={selectedFilter}
              onChange={(e) => setSelectedFilter(e.target.value)}
              className="focus:shadow-outline flex w-full rounded-lg border border-gray-500 px-5 py-1 leading-tight shadow focus:outline-none"
            >
